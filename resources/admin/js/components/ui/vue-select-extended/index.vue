...
<template>
  <div :dir="dir" class="dropdown v-select" :class="dropdownClasses">
    ...
    <transition :name="transition">
      <perfect-scrollbar v-show="dropdownOpen" :tagname="'div'" :style="{ 'max-height': maxHeight }" class="dropdown-menu">
        <ul ref="dropdownMenu">
...
<style lang="scss">
  .v-select {
    ...
    li > a {
      ...
      padding: 3px 15px;
      clear: both;
      color: #606266; /* Overrides most CSS frameworks */
      white-space: nowrap;
    }
  }
</style>
