...
class Admin extends Model
{
    ...
    {
        $custom_css_markup = file_get_contents(public_path().'/themes/admin_one/css/custom_markup/custom_css_markup.css');
        ...
        file_put_contents(public_path().'/themes/admin_one/css/custom-css.css', $custom_css_markup);
    }
}
